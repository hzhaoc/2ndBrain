...
- instruction level parallelism ([[ILP]], initially pipelining)
- cache optimization
...
- ## [[Instruction#Instruction Set Architecture|ISA]]: myopic view of computer architecture
...
# Trends in [[Architect Fundamental - Power & Energy]] in Integrated Circuit

# Trends in [[Architect Fundamental - Cost]]

# [[Architect Fundamental - Performance|Performance& Reporting]]

# Quantitative Principles of Computer Design
- parallelism
- locality
- common use priority
- [[Architect Fundamental - Performance|Amdahl's Law]]
